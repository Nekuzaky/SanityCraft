...
extends Screen {
    ...
    protected void init() {
        ...
        rowHelper.addChild(this.openScreenButton(VIDEO, () -> new VideoSettingsScreen((Screen)this, this.minecraft, this.options)));
        ...
        Button button2 = rowHelper.addChild(this.openScreenButton(TELEMETRY, () -> new TelemetryInfoScreen(this, this.options)));
        if (!this.minecraft.allowsTelemetry()) {
            button2.active = false;
            button2.setTooltip(TELEMETRY_DISABLED_TOOLTIP);
        }
