...
NarratableEntry {
    ...
    protected static void renderScrollingString(GuiGraphics guiGraphics, Font font, Component component, int i, int j, int k, int l, int m) {
        AbstractWidget.renderScrollingString(guiGraphics, font, component, (i + k) / 2, i, j, k, l, m);
    }
    ...
    protected void renderScrollingString(GuiGraphics guiGraphics, Font font, int i, int j) {
        ...
        AbstractWidget.renderScrollingString(guiGraphics, font, this.getMessage(), k, this.getY(), l, this.getY() + this.getHeight(), j);
    }
    ...
    public boolean mouseClicked(double d, double e, int i) {
        ...
        if (this.isValidClickButton(i) && (bl = this.isMouseOver(d, e))) {
    ...
    public boolean isMouseOver(double d, double e) {
        return this.active && this.visible && this.areCoordinatesInRectangle(d, e);
    }
