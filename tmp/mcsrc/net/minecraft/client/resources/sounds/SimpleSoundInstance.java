...
extends AbstractSoundInstance {
    ...
    public static SimpleSoundInstance forUI(SoundEvent soundEvent, float f, float g) {
        return new SimpleSoundInstance(soundEvent.location(), SoundSource.UI, g, f, SoundInstance.createUnseededRandom(), false, 0, SoundInstance.Attenuation.NONE, 0.0, 0.0, 0.0, true);
    }
    ...
    public static SimpleSoundInstance forLocalAmbience(SoundEvent soundEvent, float f, float g) {
        return new SimpleSoundInstance(soundEvent.location(), SoundSource.AMBIENT, g, f, SoundInstance.createUnseededRandom(), false, 0, SoundInstance.Attenuation.NONE, 0.0, 0.0, 0.0, true);
    }
    ...
    private SimpleSoundInstance(SoundEvent soundEvent, SoundSource soundSource, float f, float g, RandomSource randomSource, boolean bl, int i, SoundInstance.Attenuation attenuation, double d, double e, double h) {
        this(soundEvent.location(), soundSource, f, g, randomSource, bl, i, attenuation, d, e, h, false);
    }
